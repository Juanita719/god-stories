...
= 2.7 =
* some css support (https://wordpress.org/support/topic/add-class-to-output-for-css/) to make customizing easier

= 2.6 =
* removed filtering for last activity in wigets due to performance problems with huge user databases
